...
class IntentRouter:
    ...
    The router is responsible for selecting the correct handler
    and executing it with the conversation input.
    """
    ...
    def __init__(
        ...
        self._handlers: dict[Intent, BaseConversationHandler] = {
    ...
    def route(
        ...
        Returns:
            ConversationOutput produced by the selected handler.
        """
